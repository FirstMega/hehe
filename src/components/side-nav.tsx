...
const SideNav = () => {
  return (
    <div className="md:w-60 h-screen flex-1 fixed border-r border-gray-500 bg-zinc-900 hidden md:flex">
      <div className="flex flex-col space-y-6 w-full">
        <Link href="/" className="flex flex-row space-x-3 items-center justify-center md:justify-start md:px-6 border-b border-gray-500 h-12 w-full">
          <span className="h-7 w-7 bg-violet-600 rounded-lg" />
          <span className="font-bold text-xl hidden md:flex">Room 33</span>
        </Link>
